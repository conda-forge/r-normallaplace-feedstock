...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-normallaplace-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=15086&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-normallaplace-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-normallaplace` can be installed with:

```
conda install r-normallaplace
```

It is possible to list all of the versions of `r-normallaplace` available on your platform with:
